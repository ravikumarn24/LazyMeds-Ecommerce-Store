export const Products = [
    {
        id:1,
        name:'Nestle Nan Pro Stage 1 Powder Tin 400gm',
        type: 'Baby care',
        mrp:  580,
        discount: 0.05,
    ...
    {
        id:2,
        name:'Nestle Nan Pro Stage 2 follow up Refill 400gm',
        type: 'Baby care',
        mrp: 575,
        discount: 0.05,
    ...
    {
        id:3,
        name:'Nestle Nan Pro stage 3 Follow up refill 400gm',
        type: 'Baby care',
        mrp: 565,
        discount: 0.05,
    ...
    {
        id:4,
        name:'Nestle nan pro stage 4 Follow up refill 400 gm',
        type: 'Baby care',
        mrp: 540,
        discount: 0.05,
    ...
    {
        id:5,
        name:'Himalaya baby shampoo 60ml',
        type: 'Baby care',
        mrp: 55,
        discount: 0.2,
    ...
    {
        id:6,
        name:'Himalaya baby shampoo 100ml',
        type: 'Baby care',
        mrp: 82,
        discount: 0.2,
    ...
    {
        id:10,
        name:'Himalaya baby massage oil 100ml',
        type: 'Baby care',
        mrp: 88,
        discount: 0.2,
    ...
    {
        id:12,
        name:'Tiger Balm white ointment 21ml',
        type: 'OTC and Health care',
        mrp: 70,
        discount: 0.2,
    ...
    {
        id:13,
        name:'Tiger Balm red ointment 9ml',
        type: 'OTC and Health care',
        mrp: 40,
        discount: 0.2,
    ...
    {
        id:21,
        name:'Bilginoglu Olive oil 100ml',
        type: 'OTC and Health care',
        mrp: 180,
        discount: 0.2,
    ...
    {
        id:24,
        name:'Ponds light moisturizer 75ml',
        type: 'Personal care',
        mrp: 115,
        discount: 0.2,
    ...
    {
        id:28,
        name:'Garnier Acne fight 6 in 1 pimple clear face wash 50gm',
        type: 'Personal care',
        mrp: 90,
        discount: 0.2,
    ...
    {
        id:29,
        name:'Head and shoulders shampoo cool menthol 180ml',
        type: 'Personal care',
        mrp: 145,
        discount: 0.2,
    ...
    {
        id:32,
        name:'Garnier colour naturals black (70ml+ 60gm)',
        type: 'Personal care',
        mrp: 180,
        discount: 0.2,
